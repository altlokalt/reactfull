...
const MarketPage = () => {
  ...
  return (
    <>
      <div className="bg-white_A700 flex sm:flex-col md:flex-col flex-row font-outfit sm:gap-[20px] md:gap-[20px] items-start mx-[auto] pb-[50px] w-[100%]">
        ...
        <div className="flex flex-1 flex-col gap-[35px] items-center justify-start md:px-[20px] w-[100%]">
          ...
          <div className="flex flex-col font-urbanist gap-[21px] items-start justify-start md:w-[100%] w-[95%]">
            ...
            <div className="flex flex-col items-center justify-start md:ml-[0] ml-[2px] w-[100%]">
              ...
              <Button
                className="cursor-pointer font-normal min-w-[106px] mt-[50px] not-italic text-[14px] text-center text-gray_901 tracking-[0.14px] w-[auto]"
                variant="OutlineGray901"
              >
                Load More
              </Button>
            </div>
